...
$query2 = 'SELECT clo FROM saprebetrec WHERE  DATE(`time`) = CURDATE() ORDER BY id DESC   ';
...
$query1 = 'SELECT period ,ans FROM saprebetrec WHERE  DATE(`time`) = CURDATE() ORDER BY id DESC ';
...
$perio = $row3['period'];
$p = $perio - 1;
$sql = "SELECT * FROM saprebetrec WHERE period=$p";
...
$opt11 = "SELECT COUNT(*) as total11 FROM `saprebetrec` WHERE clo='green' AND DATE(`time`) = CURDATE()";
...
$opt12 = "SELECT COUNT(*) as total12 FROM `saprebetrec` WHERE clo='red' AND DATE(`time`) = CURDATE()";
...
$opt13 = "SELECT COUNT(*) as total13 FROM `saprebetrec` WHERE res1='violet' AND DATE(`time`) = CURDATE()";
