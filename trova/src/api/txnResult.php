...
$username = "quick-win"; // replace with your username
$password = "quick-win"; // replace with your password
$dbname = "quick-win"; // replace with your database name
...
$secret = 'KFL9YVqxsG'; // Your Secret Key.
