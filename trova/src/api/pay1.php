...
<input id="text" type="hidden" name="amount" value="<?php echo $am;?>"  />
                    ...
                    <div data-v-400f7872="" class="container-row btn-box"><button data-v-400f7872="" onclick="window.location.href='upi://pay?pa=<?php echo $upiid;?>&pn=color1.dhamakamoney.com&am=<?php echo $am;?>&cu=INR&tn=Recharge'"
