...
$query =  "SELECT  username,usercode,balance FROM users WHERE status=1 ORDER BY id DESC ";
...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $dataRow = $dataRow."<tr class='user' ><td >$row2[0]</td><td>$row2[1]</td><td>$row2[2]</td></tr>";
}
...
<body>
 ...
 <input id="searchbar" onkeyup="search()" type="text"
        ...
        <h2 style="font-size:20px;padding:5px; color:black; text-align:center;" >Blocked Users</h2>
<div>
