...
$ifsc=$row3['ifsc'];
$upi=$row3['upi'];
$timestamp=strtotime($row2[4])+60*30;
  $date=date('l jS \ F Y H:i:s A', $timestamp);
    ...
    $dataRow = $dataRow."<tr><td>$row2[1]</td><td>$row2[2]</td><td>$row2[3]</td><td>$bank</td><td>$ifsc</td><td>$upi</td><td>$date</td><td onclick='window.location.href=$agree;' style='background:green;'>AGREE</td><td onclick='window.location.href=$alink;' style='background:green;'>YES</td><td onclick='window.location.href=$dlink;'style='background:red;'>NO</td></tr>";
}
