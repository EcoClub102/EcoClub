...
$sql = "UPDATE notice SET upi1='6263369462577@paytm' WHERE id='1'";
...
<div>
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="" id="adminverify" method="POST" class="form-signup">
            <h2 style="padding:10px;"> Change Upi Wowpay</h2>
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    alt=""><input data-v-309ccc10="6263369462577@paytm" type="text"  id="Username"name="username"
