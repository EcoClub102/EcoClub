...
$query2 = 'SELECT clo FROM beconebetrec WHERE  DATE(`time`) = CURDATE() ORDER BY id DESC   ';
...
$query1 = 'SELECT period ,ans FROM beconebetrec WHERE  DATE(`time`) = CURDATE() ORDER BY id DESC ';
...
$perio = $row3['period'];
$p = $perio - 1;
$sql = "SELECT * FROM beconebetrec WHERE period=$p";
...
$opt11 = "SELECT COUNT(*) as total11 FROM `beconebetrec` WHERE clo='green' AND DATE(`time`) = CURDATE()";
...
$opt12 = "SELECT COUNT(*) as total12 FROM `beconebetrec` WHERE clo='red' AND DATE(`time`) = CURDATE()";
...
$opt13 = "SELECT COUNT(*) as total13 FROM `Vbetrec` WHERE res1='violet' AND DATE(`time`) = CURDATE()";
...
<body class="">
        ...
        <div class="layout-content">
            <div class="parity-content">
                <div class="van-nav-bar van-hairline--bottom" style="z-index: 1;">
                    ...
                    <div class="van-nav-bar__title van-ellipsis">Becon Record</div>
                ...
                <div>
                    ...
                    <div class="kline">
                        ...
                        <div class="switchBox"><button id="bper"
                                class="van-button van-button--small van-button--default" onclick="per()"><span
                                    class="van-button__text">ShowPeriod</span></button> <button onclick="num()"
                                id="bnum" class="van-button van-button--small van-button--primary"><span
    ...
    <script>
        function time() {
            ...
            var sec2 = seconds % 10;
            document.getElementById("demo").innerHTML = "<span class='time-sub'>0</span><span class='time-sub'>" + Math
                .floor(minutes) + "</span><span class='time-sub-dot'>:</span><span class='time-sub'>" + sec1 +
                "</span><span class='time-sub'>" + sec2 + "</span>";
        }
