...
$query2 = 'SELECT clo FROM emredbetrec WHERE  DATE(`time`) = CURDATE() ORDER BY id DESC   ';
...
$query1 = 'SELECT period ,ans FROM emredbetrec WHERE  DATE(`time`) = CURDATE() ORDER BY id DESC ';
...
$perio = $row3['period'];
$p = $perio - 1;
$sql = "SELECT * FROM emredbetrec WHERE period=$p";
...
$opt11 = "SELECT COUNT(*) as total11 FROM `emredbetrec` WHERE clo='green' AND DATE(`time`) = CURDATE()";
...
$opt12 = "SELECT COUNT(*) as total12 FROM `emredbetrec` WHERE clo='red' AND DATE(`time`) = CURDATE()";
...
$opt13 = "SELECT COUNT(*) as total13 FROM `emredbetrec` WHERE res1='violet' AND DATE(`time`) = CURDATE()";
        ...
        <div class="layout-content">
            <div class="parity-content">
                <div class="van-nav-bar van-hairline--bottom" style="z-index: 1;">
                    ...
                    <div class="van-nav-bar__title van-ellipsis">Emred Record</div>
